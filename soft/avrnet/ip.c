...
{
	cprintf("IP Addr : "); netPrintIPAddr(IpMyConfig.ip);	cprintf("\n");
	cprintf("Netmask : "); netPrintIPAddr(IpMyConfig.netmask);	cprintf("\n");
	cprintf("Gateway : "); netPrintIPAddr(IpMyConfig.gateway);	cprintf("\n");
}
